...
export async function getIssue(issueId: IssueId, communityId: string): Promise<Issue> {
    const issueResponse: IssueResponse = await get<IssueResponse>(`/communities/${communityId}/issues/${issueId.id}`)
